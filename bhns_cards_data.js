...
{ id: "B3", cat: "B", name: "Long GRBs / collapsars (broad-lined Ic SNe)",
    why: "A rapidly spinning, stripped massive star whose core collapses to a black hole and launches a relativistic jet. ",
    signal: "The jet is seen as a long gamma-ray burst, the explosion as a broad-lined (= very high-velocity) Type Ic supernova ",
    img : "bhns_card_images/phenomena/collapsar.png", imgscale: 1.5, imgpos: "center",
    answers: "Fermi, Swift, CTAO (TeV afterglows), VLT/ELT, VLA" },
  ...
  { id: "C1", cat: "C", name: "Isolated Neutron Star",
    why: "Radio pulsars (incl. millisecond & recycled) Clocks that reveal NS spins, B-fields, binary history (recycling) and post-SN orbits.",
  ...
  { id: "D1", cat: "D", name: "Low-mass X-ray binaries",
    ...
    answers: "Einstein Probe, MAXI, Swift, NICER, VLA/SKA (jets)" },
  ...
  { id: "D3", cat: "D", name: "Dormant (detached) BH/NS + star binaries",
    ...
    why: "Double neutron-star systems reveal compact-object progenitors and enable precision tests of gravity, while recycled/millisecond pulsars trace past mass transfer and include some of the most massive known neutron stars.",
    signal: "Precision pulsar timing, supplemented by optical observations of companions.",
    img : "bhns_card_images/phenomena/pulsars_in_bin.png", imgscale: 0.8, imgpos: "center",
    answers: "MeerKAT, SKA-Mid, FAST, GBT, Effelsberg, Parkes, Rubin, VLT, Fermi-LAT" },
  ...
  { id: "E2", cat: "E", name: "Merging binary neutron star",
    ...
    answers: "LVK/ET/CE + Fermi/Swift + Rubin/BlackGEM/GOTO/ZTF + ULTRASAT/UVEX + JWST/ELT/VLT + VLA/SKA + Chandra" },
...
const TELESCOPE_CARDS = [
  // ---------- GW & other messengers ----------
  { band: "gw", core: true, name: "LIGO–Virgo–KAGRA (LVK)", link: "https://en.wikipedia.org/wiki/LIGO",
  ...
  { band: "optTD", core: true, name: "Vera C. Rubin Observatory (LSST)", link: "https://en.wikipedia.org/wiki/Vera_C._Rubin_Observatory",
  ...
  { band: "optTD", core: false, name: "All Sky Automated Survey for SuperNovae (ASAS-SN)", link: "https://en.wikipedia.org/wiki/All_Sky_Automated_Survey_for_SuperNovae_(ASAS-SN)",
    ...
    notes: "20 robotic telescopes in both the northern and southern hemispheres",
  ...
  { band: "optSp", core: true, name: "Gaia", link: "https://en.wikipedia.org/wiki/Gaia_(spacecraft)",
  ...
  { band: "optSp", core: true, name: "Sloan Digital Sky Survey (SDSS)", link: "https://en.wikipedia.org/wiki/Sloan_Digital_Sky_Survey",
    ...
    notes: "Observing from both hemispheres (APO + LCO). https://www.sdss.org/instruments/",
  ...
  { band: "optSp", core: false, name: " 4-metre Multi-Object Spectroscopic Telescope (4most)",
    ...
    notes: "4MOST will be a fibre-fed spectroscopic facility on the VISTA telescope with a large field-of-view to survey a significant fraction of the southern sky in a few years. 4MOST will have a high multiplex being able to simulataneously obtain spectra for ~2400 objects.",
  ...
  { band: "optSp", core: true, name: "Very Large Telescope (VLT) ", link: "https://en.wikipedia.org/wiki/Very_Large_Telescope",
  ...
  { band: "uv", core: false, name: "Galaxy Evolution Explorer (GALEX)", link: "https://en.wikipedia.org/wiki/GALEX",
    ...
    notes: "Archival: mission ended 2013; the archive remains a key resource.",
    ...
    { band: "xray", core: false, name: "NuSTAR", link: "https://en.wikipedia.org/wiki/NuSTAR",
      ...
      notes: "a NASA space-based X-ray telescope that uses a conical approximation to a Wolter telescope to focus high energy X-rays from astrophysical sources, especially for nuclear spectroscopy. Operates in the range of 3 to 79 keV",
    ...
    { band: "xray", core: true, name: "Neutron Star Interior Composition Explorer (NICER)", link: "https://en.wikipedia.org/wiki/Neutron_Star_Interior_Composition_Explorer",
      ...
      notes: "Mounted on the ISS. Designed and dedicated to the study of the extraordinary gravitational, electromagnetic, and nuclear physics environments embodied by neutron stars",
  ...
  { band: "gamma", core: true, name: "Swift Gamma-Ray Burst Explorer", link: "https://en.wikipedia.org/wiki/Neil_Gehrels_Swift_Observatory",
    ...
    notes: "a NASA three-telescope space observatory for studying gamma-ray bursts (GRBs) and monitoring the afterglow in X-ray and UV/visible light at the location of a burst.",
  ...
  { band: "gamma", core: true, name: "Fermi Gamma-ray Space Telescope", link: "https://en.wikipedia.org/wiki/Fermi_Gamma-ray_Space_Telescope",
    ...
    notes: "Space observatory being used to perform gamma-ray astronomy observations from low Earth orbit. Its main instrument is the Large Area Telescope (LAT), with which astronomers mostly intend to perform an all-sky survey studying astrophysical and cosmological phenomena such as active galactic nuclei, pulsars, other high-energy sources",
